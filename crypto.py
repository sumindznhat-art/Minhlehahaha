...
def advanced_algorithm(md5_input: str, hash_input: str) -> dict:
    """
    Thuật toán nâng cao kết hợp MD5 (32) + Hash (64):
    1. Nhân đôi MD5 -> 64 ký tự
    2. XOR với Hash -> lớp 1
    3. SHA256(md5 + hash) -> salt
    4. XOR salt với hash -> lớp 2
    5. SHA512(xor1 + xor2) -> 128 hex
    6. Lấy 64 hex đầu làm result
    """
